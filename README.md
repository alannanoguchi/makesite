...
[![Go Report Card](https://goreportcard.com/badge/github.com/alannanoguchi/makesite)](https://goreportcard.com/report/github.com/alannanoguchi/makesite)
...
- [X] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [X] **_FILL IN THE BLANK_**: `I will use the Google Translate library. The documentation is located at https://pkg.go.dev/cloud.google.com/go/translate. My goal is to use it to allow users with different language backgrounds to read the page.`
- [X] **Add, commit, and push to GitHub**.
